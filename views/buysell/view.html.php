...
class BeurspleinViewBuysell extends JView
{
  ...
  {    
    ...
    foreach($stocksList as $stock)
    {
      ...
      //Actie
      $stocksTable .= "\t\t<td><input type=\"button\" onclick=\"buy(this)\"
        name=\"{$stock['id']}}\" value=\"Koop\" />";
      $stocksTable .= "<input type=\"button\" onclick=\"alert('hoi')\"
        name=\"{$stock['id']}}\" value=\"Verkoop\" /></td>\r\n";
